# Pure-Python SHA-512 for MicroPython
# Based on Thomas Dixon's implementation (MIT License)
# Adapted for MicroPython: removed copy.deepcopy, sys._getframe
...
class sha512:
    ...
    _h_init = (0x6a09e667f3bcc908, 0xbb67ae8584caa73b, 0x3c6ef372fe94f82b, 0xa54ff53a5f1d36f1,
    ...
    def copy(self):
        ...
        other._output_size = self._output_size
        return other
