...
struct CODEC2 {
    ...
    /* Scratch buffers — moved off C stack to prevent overflow on ESP32 */
    COMP Sw_scratch[FFT_ENC];       /* analyse_one_frame DFT workspace   */
    COMP Aw_scratch[FFT_ENC];       /* decode synthesis filter workspace  */
    COMP Fw_scratch[FFT_ENC];       /* NLP pitch estimation workspace    */
